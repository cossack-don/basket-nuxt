<template>
  <div class="main-header">
      <h2 class="main-header__title"><nuxt-link to="/">TestList</nuxt-link></h2>

<!-- поменять путь корзины -->
        <nuxt-link to="/" class="main-header__link-basket">
            <div class="main-header__icon-bascet">
                ...
                <div class="main-header__bascet-counter">1</div>
                </div>
        </nuxt-link>
...
.main-header {
    ...
    padding-top: 20px;
    padding-bottom: 20px;
    -webkit-box-shadow: 2px 12px 12px -2px rgba(34, 60, 80, 0.2);
    -moz-box-shadow: 2px 12px 12px -2px rgba(34, 60, 80, 0.2);
      box-shadow: 2px 12px 12px -2px rgba(34, 60, 80, 0.2);
