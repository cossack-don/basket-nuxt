...
<div>
  <div class="backpack-item">
    <div class="backpack-item__header">

    <div class="backpack-item__wrapper-reiting">
            <div class="backpack-item__star-item">
          ...
          <div class="backpack-item__reiting">4.5</div>
    </div>

      <div class="backpack-item__image-item"><img src="@/assets/backpack.png" alt=""></div>
      <div class="backpack-item__icon-basket">
    ...
    <div class="backpack-item__footer">
      <p class="backpack-item__name-item">Рюкзак Louis Vuitton Discovery</p>
      <p class="backpack-item__price">150 000 ₽</p>
    </div>
  </div>
  </div>
</template>
